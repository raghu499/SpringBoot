...
public class SecondaryDbConfig {
	...
	//public static final String NAME_OF_PERSISTENCE_UNIT="com.mss.dao.TblOracle";
	public static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.mss.dao" };
	...
	@Bean
	//Convenient subclass of Spring's standard MBeanExporter, activating Java 5 annotation usage for 
	//JMX exposure of Spring beans: ManagedResource, ManagedAttribute, ManagedOperation, etc. 
